...
//    		canvas.drawText(text, middle - 112, frame.bottom + 60, textPaint);
  ...
  private void setCornerRadii(GradientDrawable mDrawable2, float r, float r2, float r3,
		  float r4) {
	  mDrawable2.setCornerRadii(new float[] { r, r, r2, r2, r3, r3,r4,r4 });
